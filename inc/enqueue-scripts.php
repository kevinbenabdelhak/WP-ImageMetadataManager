<?php
/**
 * Enqueues les scripts nécessaires
 */
...
function imm_enqueue_scripts($hook) {
    ...
    wp_enqueue_script('imm_bulk_action_script', plugin_dir_url(__FILE__) . '../assets/js/bulk-action.js', array('jquery'), '1.0', true);
    wp_localize_script('imm_bulk_action_script', 'imm_bulk_params', array(
        'ajax_url' => admin_url('admin-ajax.php'),
        'nonce' => wp_create_nonce('imm_bulk_action_nonce')
    ));

    wp_add_inline_script('imm_bulk_action_script', '
